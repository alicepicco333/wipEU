...
// Fetch the JSON data
fetch('main/databar/2024-01-26-wmidm_adm_eur__wmid_euadmin_eurag.json')
...
// Fetch the JSON data
fetch('main/databar/2024-01-26-wmidm_bus_fin__wmid_fineur.json')
  .then(response => response.json())
  .then(data => {
...
// Fetch the JSON data
fetch('main/databar/2024-01-26-wmidm_jud_eucrt__wmid_eucrt (2).json')
  .then(response => response.json())
  .then(data => {
